...
stock.push(new Producto("set tazas para Café Irlandés/ Capuchino (230 Ml)", 3800, 7, "6 Unidades",img="https://http2.mlstatic.com/D_NQ_NP_725925-MLC50128052307_052022-O.webp"));
...
stock.forEach( (elm)=>{
  ...
  cardClon.querySelector("button").addEventListener("click",()=>{
    // let productoId = Number(prompt("ID producto:"));
    let cantidad = Number(prompt("Cantidad:"));
    let producto = stock.find((product) => product.id);
